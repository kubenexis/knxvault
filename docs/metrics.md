...
| `knxvault_leader_election_running` | Gauge | — | `1` while the leader election background loop is active |
| `knxvault_active_leases` | Gauge | — | Cluster-wide count of active (non-revoked, non-expired) leases |
