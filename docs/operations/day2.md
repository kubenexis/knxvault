...
> **New operators:**  
> - **Kubernetes (full narrative):** [operator runbook](operator-runbook.md) — Day-0 through first cert/secret; this page for ongoing tables.  
> - **Kubernetes (CLI-first):** [Kubernetes CLI Day-0 / Day-2](kubernetes-cli-day0-day2.md).  
