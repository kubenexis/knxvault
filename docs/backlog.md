...
Items from the **2026-07 enterprise architecture security review**. Addresses Shamir threshold unseal, native PKI, memory hardening, token hierarchy, OIDC claim mapping, and air-gap operational gaps. **Cloud KMS auto-unseal (AWS/GCP/Azure)** → [long-term](#long-term-future) (**LT-14**, **LT-15**). **v1.0 GA blockers:** **W41-01**, **W41-02**. **v1.1:** **W41-05–W41-07**, **W41-12**. **v1.2:** **W41-08–W41-11**, **W41-13**. Customer-facing scope: [`docs/product/poc-evaluation-guide.md`](product/poc-evaluation-guide.md).
...
> **Tier I sequencing:** **W41-01** + **W41-02** before v1.0 GA (parallel with remaining W36). **W41-05** (Shamir) shares seal infrastructure with single-key unseal. **W41-06** + **W41-07** are v1.1 auth priorities. **W41-08** → **W41-09** → **W41-10** is the native PKI migration chain (after **W31-01**). **W41-12** can ship immediately (docs-only). **W41-11** optional for air-gapped K8s API constraints. **Cloud KMS (AWS/GCP/Azure)** deferred to **LT-14**, **LT-15** — use sealed K8s Secrets or external secret operators near-term.
...
| Shamir unseal, native PKI | crypto | **W41-05–W41-10** (Tier I); see [PoC evaluation guide](product/poc-evaluation-guide.md). |
